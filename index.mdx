...
Demtos Clip is an AI-powered video tool designed for churches.\
It automatically identifies key moments from long-form videos and turns them into short clips optimized for social media.

Instead of spending hours editing sermons, Demtos Clip does the heavy lifting for you.

<Card title="Start here" icon="rocket" horizontal href="/quickstart">
  Sign in to your Demtos Clip account
</Card>
